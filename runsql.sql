...
INSERT INTO skillsinfo (id, skill_name, skill_verb, skill_metric, unit_of_measurement, picture, descrip, level1, level2, level3, level4, level5)
VALUES ('5', 'Miles Run in a Week', 'Run', 'Weekly Miles', 'Miles', 'http://cdn.mos.cms.futurecdn.net/v44n2mBJgaRoCkkFGjDtRP.jpeg', 'Running is the activity of moving fast on foot, especially as a sport. Running throughout the week is an important part of aerobic fitness.', '2','5','10','20','26');
