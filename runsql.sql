...
VALUES ('1', 'Fishing', 'fish',  'catch', 'pounds', '', 'Fishing is the activity of using a rod and bait to catch aquatic life.', '5', '10', '15', '20', '25');
INSERT INTO skillsinfo (id, skill_name, skill_verb, skill_metric, unit_of_measurement, picture, descrip, level1, level2, level3, level4, level5)
VALUES ('2', 'Hot Dog Eating', 'hot dogs in an hour', 'eat', 'Hot Dogs', '', 'Hot Dog Eating is a competitive sport in which people try to consume as many hot dogs as possible.', '1', '3', '6', '9', '12');
INSERT INTO skillsinfo (id, skill_name, skill_verb, skill_metric, unit_of_measurement, picture, descrip, level1, level2, level3, level4, level5)
VALUES ('3', 'IQ', 'IQ', 'perform tests for a', 'Points', '', 'Intelligence Quotient (IQ) is a standard measure of intellect.', '85', '115', '130', '145', '159');
INSERT INTO skillsinfo (id, skill_name, skill_verb, skill_metric, unit_of_measurement, picture, descrip, level1, level2, level3, level4, level5)
